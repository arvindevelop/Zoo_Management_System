                            ...
                            <div class="col-12 mt-5">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <?php } ?>
                                    <center>
                                    <button id="paymentButton" style="margin-top:1%;cursor: pointer;" OnClick="makePayment()" >Proceed</button>
                                    </center>
                                     <p style="margin-top:1%"  align="center">
                                        <i id="printIcon" class="fa fa-print fa-2x" style="cursor: pointer;display:none;"  OnClick="CallPrint(this.value)" ><span>Print Ticket</span></i>
                                    </p>
                                </div>
                            </div>
                            <!-- basic form end -->
    ...
    <script src="assets/js/scripts.js"></script>
     ...
     <script>
         function makePayment(){
            ...
            var paymentButt = document.getElementById("paymentButton");
            var printIc = document.getElementById("printIcon");
            paymentButt.style.display="none";
            printIc.style.display="block";
         }
